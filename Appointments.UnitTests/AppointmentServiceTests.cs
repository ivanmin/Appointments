...
namespace Appointments.UnitTests
{
    public class AppointmentServiceTests
    {
        ...
        public AppointmentServiceTests()
        {
            ...
            _service = new AppointmentService(_mockLogger.Object, _mockSlotServiceRemote.Object, _mockConfiguration);
        ...
        public void MapAppointmentRequestToAppointment_ValidRequest_ReturnsCorrectAppointment()
        {
            ...
            // Act
            var response = AppointmentHelper.MapTakeAppointmentByUserRequestToAppointment(appointmentRequest);
        ...
        public async Task TakeAppointmentByUser_ValidAppointmentRequest_CallsTakeSlot()
        {
            // Arrange
            var appointmentRequest = _appointmentRequest;
            var appointment = AppointmentHelper.MapTakeAppointmentByUserRequestToAppointment(appointmentRequest);
